...
if __name__ == '__main__':
    ...
    for l in range(1):
        ...
        for i in range(epochs):
            ...
            train_loss_plt.append(loss.detach().cpu().numpy())
            train_f1_acc.append(train_f1)
            val_loss_plt.append(val_loss.detach().cpu().numpy())
            val_f1_acc.append(val_f1)
            test_loss_plt.append(test_loss.detach().cpu().numpy())
            test_f1_acc.append(test_f1)
        ...
        plt.xlim((0, 43))
        plt.ylim((0, 2))
        plt.plot(epochs, train_loss_plt, color='b', label='train_loss')
        plt.plot(epochs, test_loss_plt, color='r', label='test_loss')
        plt.plot(epochs, val_loss_plt, color='g', label='val_loss')

        plt.subplot(1, 2, 2)
        plt.title('F1_acc', fontsize='xx-large')
        plt.xlabel('epoch')
        plt.ylabel('f1_acc')
        plt.xlim((0, 43))
        plt.ylim((0, 1))
        plt.plot(epochs, train_f1_acc, color='b', label='train_f1')
        plt.plot(epochs, test_f1_acc, color='r', label='test_f1')
        plt.plot(epochs, val_f1_acc, color='g', label='val_f1')

        # plt.savefig(r'D:\HUJIE\prev_GTN\{}.png'.format('DBLP'))
